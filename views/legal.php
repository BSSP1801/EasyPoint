    ...
    <div class="company-container">
        ...
        <section id="privacy" class="content-section">
            ...
            <div class="about-text">
                ...
                <p style="margin-bottom: 20px;">
                    At <strong>EasyPoint</strong>, we take your privacy seriously. This Privacy Policy describes how we
                    collect, use, and share your personal information when you use our website and services.
                </p>

                <h3 style="color: var(--accent); font-size: 18px; margin-bottom: 10px; margin-top: 25px;">1. Information
                    We Collect</h3>
                <p style="margin-bottom: 15px;">
                    We collect information you provide directly to us, such as when you create an account, book an
                    appointment, or contact customer support. This may include your name, email address, phone number,
                    and payment information.
                </p>

                <h3 style="color: var(--accent); font-size: 18px; margin-bottom: 10px; margin-top: 25px;">2. How We Use
                    Your Information</h3>
                <p style="margin-bottom: 15px;">
                    We use your information to facilitate appointments, improve our platform, and communicate with you
                    about your bookings. We do not sell your personal data to third parties.
                </p>

                <h3 style="color: var(--accent); font-size: 18px; margin-bottom: 10px; margin-top: 25px;">3. Data
                    Security</h3>
                <p>
        ...
        <section id="terms" class="content-section">
            ...
            <div class="about-text">
                ...
                <h3 style="color: var(--accent); font-size: 18px; margin-bottom: 10px; margin-top: 25px;">1. Acceptance
                    of Terms</h3>
                <p style="margin-bottom: 15px;">
                ...
                <h3 style="color: var(--accent); font-size: 18px; margin-bottom: 10px; margin-top: 25px;">2. Booking &
                    Cancellations</h3>
                <p style="margin-bottom: 15px;">
                    When you book an appointment, you agree to honor the scheduled time. Cancellations must be made in
                    accordance with the individual business's cancellation policy. EasyPoint is not responsible for fees
                    incurred due to late cancellations or no-shows.
                </p>

                <h3 style="color: var(--accent); font-size: 18px; margin-bottom: 10px; margin-top: 25px;">3. User
                    Conduct</h3>
                <p style="margin-bottom: 15px;">
                    You agree not to use the platform for any unlawful purpose or to solicit others to perform or
                    participate in any unlawful acts. We reserve the right to terminate accounts that violate our
                    community guidelines.
                </p>

                <h3 style="color: var(--accent); font-size: 18px; margin-bottom: 10px; margin-top: 25px;">4. Limitation
                    of Liability</h3>
                <p>
                    EasyPoint acts as an intermediary between users and businesses. We are not liable for the quality of
                    services provided by the businesses listed on our platform.
                </p>
            </div>
        </section>
        ...
        <section id="cookies" class="content-section">
            ...
            <div class="about-text">
                ...
                <p style="margin-bottom: 20px;">
                    This Cookie Policy explains how EasyPoint uses cookies and similar technologies to recognize you
                    when
                    you visit our website. It explains what these technologies are and why we use them, as well as your
                    rights to control our use of them.
                </p>

                <h3 style="color: var(--accent); font-size: 18px; margin-bottom: 10px; margin-top: 25px;">1. What are
                    cookies?</h3>
                <p style="margin-bottom: 15px;">
                ...
                <h3 style="color: var(--accent); font-size: 18px; margin-bottom: 10px; margin-top: 25px;">2. Why do we
                    use
                    cookies?</h3>
                <p style="margin-bottom: 15px;">
                    We use cookies for several reasons. Some cookies are required for technical reasons in order for our
                    platform to operate, such as maintaining your login session and keeping your account secure. We
                    refer to
                    these as "essential" or "strictly necessary" cookies.
                </p>

                <h3 style="color: var(--accent); font-size: 18px; margin-bottom: 10px; margin-top: 25px;">3. How can you
                    control cookies?</h3>
                <p>
                    You have the right to decide whether to accept or reject cookies. You can set or amend your web
                    browser
                    controls to accept or refuse cookies. If you choose to reject cookies, you may still use our
                    website,
                    though your access to some functionality (like staying logged in) may be restricted.
                </p>
            </div>
        </section>
